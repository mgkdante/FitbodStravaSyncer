...
import app.secondclass.healthsyncer.ui.composables.ActionsSheet
import app.secondclass.healthsyncer.ui.composables.ConfirmDialog
    ...
    ModalBottomSheet(
        ...
        ActionsSheet(
            ...
            onSyncAll = {
                ...
                setLastActionToast(UiStrings.SYNC_ALL_REQUESTED)
                showSheet()
            },
